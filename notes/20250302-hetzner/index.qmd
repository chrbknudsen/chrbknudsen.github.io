...
sudo su - -c "R -e \"install.packages('tidyverse', 'shiny')\""

Rstudio server understøtter ikke arm64 - så den installerer vi ikke.

Shinyserver

Hm. der er tilsvarende problemer. arm64 har dårlig understøttelse.
