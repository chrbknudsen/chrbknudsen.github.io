...
That is rather simple. What is not so simple, is that there can be two x'es. One, in black, to denote the current state of affairs. And a second x, in red, to denote what a future, preferred state should be.
